    ...
    <div className='shelter__container'>
      <form className='shelter__container-form'>
        ...
        <div>
            ...
            <label>
                <input type="radio" name="playfulPet" value="1" checked/>
                Not at all
            </label>
            <label>
                <input type="radio" name="playfulPet" value="2"/>
                Very playful
            </label>
            <label>
                <input type="radio" name="playfulPet" value="3"/>
                Somewhat
            </label>
        </div><br></br>
        ...
        <div>
            ...
            <label>
                <input type="radio" name="laidbackPet" value="1" checked/>
                Not at all
            </label>
            <label>
                <input type="radio" name="laidbackPet" value="2"/>
                Very laidback
            </label>
            <label>
                <input type="radio" name="laidbackPet" value="3"/>
                Somewhat
            </label>
        </div><br></br>
