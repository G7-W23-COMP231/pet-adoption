  ...
  return (
    <div className='shelter__container'>
      <form className='shelter__container-form'>
        ...
        <label>
        <input type="radio" name="option" value="option1" checked={selectedValue === "option1"} onChange={handleChange} />
        Option 1
      </label>
      <label>
        <input type="radio" name="option" value="option2" checked={selectedValue === "option2"} onChange={handleChange} />
        Option 2
      </label>
      <label>
        <input type="radio" name="option" value="option3" checked={selectedValue === "option3"} onChange={handleChange} />
        Option 3
      </label>
        </div>
