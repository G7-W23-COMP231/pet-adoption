    ...
    <div className='shelter__container'>
      <form className='shelter__container-form'>
        ...
        <div>
            ...
            <input type="checkbox" name="option1" value="Option 1"> Option 1</input>
            <input type="checkbox" name="option2" value="Option 2"> Option 2</input>
            <input type="checkbox" name="option3" value="Option 3"> Option 3</input>
