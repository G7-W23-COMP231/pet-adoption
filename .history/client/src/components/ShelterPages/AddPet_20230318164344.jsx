    ...
    <div className='shelter__container'>
      <form className='shelter__container-form'>
        ...
        <div>
            ...
            <input type="checkbox" name="canGetWithHumanAge" value="1"/>Children under 8 years old
            <input type="checkbox" name="canGetWithHumanAge" value="2"/>Children over 8 years old
