    ...
    <div className='shelter__container'>
      <form className='shelter__container-form'>
        ...
        <label>Can get along with humans whose ages are (click all that apply):</label>
          <input type="checkbox" name="canGetWithHumanAge" value="1"/> Option 1
          <input type="checkbox" name="canGetWithHumanAge" value="2"/> Option 2
          <input type="checkbox" name="canGetWithHumanAge" value="3"/> Option 3
        </div>
