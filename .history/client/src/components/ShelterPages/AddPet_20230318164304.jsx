  ...
  return (
    <div className='shelter__container'>
      <form className='shelter__container-form'>
        ...
        <div>
            <label>Can get along with humans whose ages are (click all that apply):</label>
            <input type="checkbox" name="canGetWithHumanAge" value="1">Children under 8 years old</input>
            <input type="checkbox" name="canGetWithHumanAge" value="2">Children over 8 years old</input>
            <input type="checkbox" name="canGetWithHumanAge" value="3">Elderly</input>
        </div>
