      ...
      <form className='shelter__container-form'>
        ...
        <div>
            <label>Good for first time pet owner</label>
              ...
              <label>
    <input type="radio" name="gwithFirstPetOwner" value="option1" checked>
    Option 1
  </label>
  <label>
    <input type="radio" name="gwithFirstPetOwner" value="option2">
    Option 2
  </label>
  <label>
    <input type="radio" name="gwithFirstPetOwner" value="option3">
    Option 3
  </label>
